...
{
	private final RandomCharacter randomCharacterGenerator = new RandomCharacter();
	 ...
	 */
	private final Function<Integer, List<Character>> listGenerator = size -> IntStream
			.range(0, size)
			.mapToObj(value -> randomCharacterGenerator.getRandomChar())
			.toList();
